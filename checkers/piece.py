...
class Piece:
	...
	def get_value(self):
		return str([self.player, self.other_player, self.king, self.captured, self.position, self.board, self.capture_move_enemies])

	# def __eq__(self, other):
	# 	return str(self.player, self.other_player, self.king, self.captured, self.position, self.board, self.capture_move_enemies) == str(other.player, other.other_player, other.king, other.captured, other.position, other.board, other.capture_move_enemies)

	# def __hash__(self):
	# 	return hash(str(self.player, self.other_player, self.king, self.captured, self.position, self.board, self.capture_move_enemies))
